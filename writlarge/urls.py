...
urlpatterns = [
    ...
    url(r'^site/view/(?P<pk>\d+)/$', views.LearningSiteDetailView.as_view(),
        name='learning-site-detail-view'),
    url(r'^archive/view/(?P<pk>\d+)/$',
        views.ArchivalRepositoryDetailView.as_view(),
        name='archival-repository-detail-view'),
    url(r'^site/edit/(?P<pk>\d+)/$', views.LearningSiteUpdateView.as_view(),
        name='learning-site-update-view'),
    url(r'^archive/edit/(?P<pk>\d+)/$',
        views.ArchivalRepositoryUpdateView.as_view(),
        name='archival-repository-update-view'),
